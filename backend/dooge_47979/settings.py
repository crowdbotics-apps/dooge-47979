"""
Django settings for dooge_47979 project.
...
WSGI_APPLICATION = 'dooge_47979.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dooge_47979 API",
    "DESCRIPTION": "API documentation for dooge_47979 App",
    "VERSION": "v1",
}
